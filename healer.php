...
// Defensive unserialize: only unserialize if value is a non-empty string, not "0", and looks like a serialized value
$donationconfig_raw = $session['user']['donationconfig'] ?? '';
if (
    is_string($donationconfig_raw) &&
    $donationconfig_raw !== '' &&
    $donationconfig_raw !== '0' &&
    ($donationconfig_raw[0] === 'a' || $donationconfig_raw[0] === 'O' || $donationconfig_raw[0] === 's' || $donationconfig_raw[0] === 'i' || $donationconfig_raw[0] === 'b' || $donationconfig_raw[0] === 'N')
) {
